...
class Tasks extends AdminController
{
    ...
    public function get_tasks()
    {
        ...
        $this->load->view('admin/tasks/tasks_select', $data);
    ...
    public function get_related()
    {
        ...
        if($rel_type == 'invoice'){
            ...
            $data['select_options'] = $this->projects_model->get();
        }
        $data['rel_type'] = $rel_type;
        $this->load->view('admin/tasks/related_select', $data);
    }
    ...
    public function task_pdf()
    {
        ...
        $this->load->view('admin/tasks/pdf_select', $data);
