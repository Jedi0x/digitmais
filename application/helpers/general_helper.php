...
function generate_barcode($code,$task)
{
    $CI = & get_instance();
    $CI->load->library('barcode');
    $tempDir = $_SERVER['DOCUMENT_ROOT'].'/digitam_mas/uploads/barcode/';
    file_put_contents($tempDir.$task.'.png',$CI->barcode->generate($code));
}
