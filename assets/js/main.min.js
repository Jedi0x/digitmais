...
function initDataTableInline(e) {
    appDataTableInline(e, { supportsButtons: !0, supportsLoading: !0, autoWidth: !1, scrollResponsive: app.options.scroll_responsive_tables });
}
    ...
    var m = {
        ...
        initComplete: function (e, t) {
            ...
            s.length && s.attr("colspan", a.find("thead th").length),
                is_mobile() && $(window).width() < 400 && 0 < a.find('tbody td:first-child input[type="checkbox"]').length && (a.DataTable().column(0).visible(!1, !1).columns.adjust(), $("a[data-target*='bulk_actions']").addClass("hide")),
...
function print_task_pdf() {
   ...
   url = typeof (url) != 'undefined' ? url : admin_url + 'tasks/task_pdf';
...
function init_orders(e) {
    load_small_table_item(e, "#order", "orderid", "orders/get_invoice_data_ajax", ".table-orders");
}
        ...
        return (
            get_taxes_dropdown_template(a, n.taxname).done(function (e) {
                (p += '<input type="hidden" class="order" name="newitems[' + _ + '][order]">'),
                    ...
                    (p += '<td><textarea name="newitems[' + _ + '][long_description]" class="form-control item_long_description" rows="5">' + n.long_description.replace(l, "\n") + "</textarea></td>");
...
function merge_field_format_url(e, t, a, i) {
    return -1 < e.indexOf("%7B") && -1 < e.indexOf("%7D") && (e = e.replaceAll("%7B", "{").replaceAll("%7D", "}")), e;
}
    ...
    $(function () {
        ...
        if (
            ...
            var o = {
                ...
                customButtons: {},
                header: { left: "prev,next today", center: "title", right: "month,agendaWeek,agendaDay,viewFullCalendar,calendarFilter" },
                editable: !1,
                        ...
                        data: function () {
                            ...
                            return (
                                $("#calendar_filters")
                                    ...
                                    .get(),
                                jQuery.isEmptyObject(e) || (e.calendar_filters = !0),
                                e
                            );
                        },
                        type: "POST",
        ...
        var r = { custom_view: "[name='custom_view']", assigned: "[name='view_assigned']", status: "[name='view_status[]']", source: "[name='view_source']" };
        if ((table_leads = $("table.table-leads")).length) {
            var c = table_leads.find("#th-consent"),
                p = [0],
                _ = [0, table_leads.find("#th-assigned").index()];
            0 < c.length && (p.push(c.index()), _.push(c.index())),
                (_table_api = initDataTable(table_leads, admin_url + "leads/table", _, p, r, [table_leads.find("th.date-created").index(), "desc"])),
                _table_api &&
                    0 < c.length &&
        ...
        if (((table_invoices = $("table.table-invoices")), (table_estimates = $("table.table-estimates")), 0 < table_invoices.length || 0 < table_estimates.length)) {
            ...
            $.each(f, function () {
                ...
                table_estimates.length &&
                    initDataTable(table_estimates, admin_url + "estimates/table", "undefined", "undefined", u, [
                        [3, "desc"],
                        [0, "desc"],
                    ]);
        }
        if ((table_tasks = $(".table-tasks")).length) {
            ...
            $("body").hasClass("tasks-page") && (g += "?bulk_actions=true"),
                (_table_api = initDataTable(table_tasks, g, b, b, v, [table_tasks.find("th.duedate").index(), "asc"])),
